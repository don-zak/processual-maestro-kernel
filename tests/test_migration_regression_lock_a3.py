...
def test_commercial_migrations_render_offline_without_runtime_database_access(
    ...
    ranges = (
        ...
        ("upgrade", "20260809_0046:20260828_0047r"),
        ("downgrade", "20260828_0047r:20260809_0046"),
    )
...
def test_online_downgrade_guards_remain_explicit_and_offline_safe() -> None:
    guarded_migrations = {
        ...
        "20260828_0047r_repair_admin_market_order_status_constraint.py": (
