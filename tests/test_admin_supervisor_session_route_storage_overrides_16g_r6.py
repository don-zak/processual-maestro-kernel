...
from processual_api.routers import (
    settings_supervisor_session_keys_authority as supervisor_authority_routes,
)
...
def _patch_owner_admin_jwt(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    # These tests qualify environment-governed storage and audit paths only.
    # Canonical persisted platform-admin authorization is tested separately.
    monkeypatch.setattr(
