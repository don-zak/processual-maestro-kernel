...
def test_client_api_key_integration_card_exposes_request_workflow_controls() -> None:
    html = _settings_page_html()
    ...
    markers = (
        ...
        "set-api-key-request-status",
        "Request integration key provisioning",
        "Request key rotation",
        "Request key deactivation",
...
def test_client_api_key_integration_script_prefills_safe_key_requests() -> None:
    js = SETTINGS_JS.read_text(encoding="utf-8")
