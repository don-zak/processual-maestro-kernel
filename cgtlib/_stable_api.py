"""Dependency-light declaration of the stable public cgtlib API surface.

This module must remain importable when the private CGT engine is absent. Keep it
free of imports from runtime/evaluator modules so the public fallback can depend
on the contract without traversing private-engine dependencies.
"""
