...
from cgtlib._fallback import compute_self_potential as _compute_self_potential
...
def compute_self_potential(
    ...
    return _compute_self_potential(phase_mass, mean_retention, harmony, fatigue, omega)
